...
experimental:
  plugins:
    keycloakopenid:
      moduleName: "github.com/Clarilab/keycloakopenid"
      version: "v0.1.0"
```
    ...
    my-keycloakopenid:
      plugin:
        keycloakopenid:
          ...
          KeycloakRealm: "<REALM"
          Scope: "<Scope [space delimited] (default: 'openid', example: 'openid profile email')"
          TokenCookieName: "<TOKEN_COOKIE_NAME (default: 'AUTH_TOKEN')"
          UseAuthHeader: "<true|false (default: false)"
          IgnorePathPrefixes: "/api,/favicon.ico [comma delimited] (optional)"
```
    ...
    my-keycloakopenid:
      plugin:
        keycloakopenid:
          ...
          ScopeEnv: "SCOPE [space delimited] (default: 'openid', example: 'openid profile email')"
...
This plugin additionally provides the option to define a condition based on a regular expression applied to a claim.

If the condition is not met, the request will be denied with a 403 status code and the message "insufficient permissions", instead of granting access to the website.
    ...
    my-keycloakopenid:
      plugin:
        keycloakopenid:
          ...
          Scope: "<SCOPE [space delimited] (default: 'openid', example: 'openid profile email')"
          TokenCookieName: "TOKEN_COOKIE_NAME (default: "AUTH_TOKEN)"
          ConditionalAccessClaim: "groups"
          ConditionalAccessRegexp: ".*(?:/admin).*"
```

## Special thanks

Special thanks to the original project [Gwojda/keycloakopenid](https://github.com/Gwojda/keycloakopenid) for providing the foundation on which this plugin was built.
